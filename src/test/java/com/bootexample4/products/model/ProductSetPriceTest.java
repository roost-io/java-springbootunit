...
public class ProductSetPriceTest {
	...
	public void setNegativePrice() {
		...
		// Assert
		assertEquals(-5.00, product.getPrice());
	}
	...
	public void setNullPrice() {
		...
		// Act and Assert
		// Business logic needs to be improved to handle null price
		// Comment: The setPrice method should throw NullPointerException when a null
		// price is passed
		NullPointerException exception = assertThrows(NullPointerException.class, () -> product.setPrice(null));
	}
	...
	public void setPriceOnInitializedObject() {
		...
		// Assert
		assertEquals(20.99, product.getPrice());
	}
